...
describe('ExternalThumbnailsHandler', () => {
  ...
  describe('_downloadAndParseCues', () => {
    it('should download and parse the vtt file- vtt with url options only', async () => {
      await externalThumbnailsHandler._downloadAndParseCues({vttUrl: '/base/test/src/assets/thumbnails1.vtt'});
    ...
    it('should download and parse the vtt file - vtt with size options only', async () => {
      await externalThumbnailsHandler._downloadAndParseCues({vttUrl: '/base/test/src/assets/thumbnails2.vtt'});
    ...
    it('should download and parse the vtt file - vtt with size and coords options', async () => {
      await externalThumbnailsHandler._downloadAndParseCues({vttUrl: '/base/test/src/assets/thumbnails3.vtt'});
  ...
  describe('_formatIntoThumbnailCues', () => {
    ...
    it('should throw an error - invalid url option', async () => {
      const invalidVttCues = [
        {startTime: 0, endTime: 5, imgUrl: 'base/test/src/bbb-sprite.jpeg', size: {width: 128, height: 72}, coordinates: {x: 0, y: 0}},
        {startTime: 5, endTime: 10, imgUrl: 'base/test/src/bbb-sprite.jpeg', size: {width: 128, height: 72}, coordinates: {x: 128, y: 0}}
      ];
