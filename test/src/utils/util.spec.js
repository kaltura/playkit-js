...
describe('util', () => {
  ...
  describe('Object', function () {
    ...
    describe('isGetter', function () {
      ...
      it('should find getter in oldest prototype', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'dummyA');
        hasGetter.should.be.true;
      });
      it('should find getter in older prototype', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'dummyB');
        hasGetter.should.be.true;
      });
      it('should find getter in object prototype', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'dummyC');
        hasGetter.should.be.true;
      });
      it('should return false for non existence method/getter', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'dummyNotExist');
        hasGetter.should.be.false;
      });
      it('should return false for function', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'methodA');
        hasGetter.should.be.false;
      });
      it('should return false for function', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'methodB');
        hasGetter.should.be.false;
      });
      it('should return false for function', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'methodC');
        hasGetter.should.be.false;
      });
      it('should return false for setter', () => {
        const temp = new C();
        const hasGetter = Utils.Object.isGetter(temp, 'dummy12');
        hasGetter.should.be.false;
      });
    });
  });
