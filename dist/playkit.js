...
var _jsLogger = __webpack_require__(34);
...
var _severity = __webpack_require__(37);
...
var Error = function () {
  ...
  function Error(severity, category, code) {
    ...
    this.code = code;
    this.data = data;
    if ((0, _logger.getLogLevel)(CLASS_NAME) === _logger.LogLevel.DEBUG) {
  ...
  _createClass(Error, [{
    key: '_createReadableError',
    value: function _createReadableError(category, code) {
      var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

      var codeName = this._getKey(Error.Code, code);
      var categoryName = this._getKey(Error.Category, category);
    ...
    key: '_getKey',
    value: function _getKey(obj, value) {
...
var _pluginManager = __webpack_require__(25);
...
var _stateManager = __webpack_require__(46);

var _stateManager2 = _interopRequireDefault(_stateManager);

var _trackTypes = __webpack_require__(48);
...
var _textTrackDisplay = __webpack_require__(24);

var _playbackMiddleware = __webpack_require__(49);

var _playbackMiddleware2 = _interopRequireDefault(_playbackMiddleware);

var _playerOptions = __webpack_require__(27);

var _playerOptions2 = _interopRequireDefault(_playerOptions);
...
var Player = function (_FakeEventTarget) {
  ...
  function Player() {
    ...
    _this._config = _this.defaultConfig;
  ...
  _createClass(Player, [{
    ...
    value: function _play() {
      ...
      if (this._engine.src) {
        ...
        this.ready().then(function () {
          ...
          _this10.dispatchEvent(new _fakeEvent2.default(_events.HTML5_EVENTS.ERROR, error));
        });
      }
    }
    ...
    key: 'defaultConfig',
    get: function get() {
      return new _playerOptions2.default().toJSON();
    }
  }, {
    key: 'Event',
    get: function get() {
...
var EngineName = exports.EngineName = {
  HTML5: "html5",
  FLASH: "flash",
  SILVERLIGHT: "silverlight"
};
var FormatName = exports.FormatName = {
  HLS: "hls",
  DASH: "dash",
  PROGRESSIVE: "progressive"
};

var StreamPriority = function () {
  _createClass(StreamPriority, [{
    key: "engine",
    get: function get() {
      return this._engine;
    }
  ...
  function StreamPriority(engine, format) {
    _classCallCheck(this, StreamPriority);

    validate(engine, format);
    if (typeof engine === 'string') {
      this._engine = engine;
      this._format = format;
    } else if ((typeof engine === "undefined" ? "undefined" : _typeof(engine)) === 'object') {
...
exports.default = StreamPriority;
function validate() {
  ...
  if (_typeof(params[0]) === 'object' && typeof params[0].engine === 'string' && typeof params[0].format === 'string') return;
...
var _drmData = __webpack_require__(28);

var _drmData2 = _interopRequireDefault(_drmData);
  ...
  _createClass(MediaSource, [{
    ...
    set: function set(value) {
      ...
      value.forEach(function (d) {
        return _this._drmData.push(new _drmData2.default(d.scheme, d.licenseUrl, d.certificate));
      });
    }
  }]);

  function MediaSource(mimetype, url, id) {
    ...
    } else if ((typeof mimetype === 'undefined' ? 'undefined' : _typeof(mimetype)) === 'object') {
...
function validate() {
  ...
  if (typeof params[0] === 'string' && typeof params[1] === 'string') return;
  if (_typeof(params[0]) === 'object' && typeof params[0].mimetype === 'string' && typeof params[0].url === 'string') return;
...
var _nativeAdapter = __webpack_require__(36);
...
BaseMediaSourceAdapter.Html5Events = _events.HTML5_EVENTS;
...
var _drmSupport = __webpack_require__(42);
  ...
  _createClass(PluginManager, [{
    ...
    value: function load(name, player) {
      ...
      if (!PluginManager._registry.has(name)) {
        throw new _error2.default(_error2.default.Severity.CRITICAL, _error2.default.Category.PLAYER, _error2.default.Code.RUNTIME_ERROR_NOT_REGISTERED_PLUGIN, name);
      }
    ...
    value: function register(name, handler) {
      if (typeof handler !== 'function' || handler.prototype instanceof _basePlugin2.default === false) {
        throw new _error2.default(_error2.default.Severity.CRITICAL, _error2.default.Category.PLAYER, _error2.default.Code.RUNTIME_ERROR_NOT_VALID_HANDLER, name);
      }
      if (!PluginManager._registry.has(name)) {
...
exports.defaultPlayerOptions = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _playbackConfig = __webpack_require__(51);

var _playbackConfig2 = _interopRequireDefault(_playbackConfig);

var _sourcesConfig = __webpack_require__(54);

var _sourcesConfig2 = _interopRequireDefault(_sourcesConfig);

var _metadataConfig = __webpack_require__(56);

var _metadataConfig2 = _interopRequireDefault(_metadataConfig);

var _pluginsConfig = __webpack_require__(57);
...
var defaultPlayerOptions = exports.defaultPlayerOptions = {
  logLevel: 'ERROR',
  playback: _playbackConfig.defaultPlaybackConfigObject,
  sources: _sourcesConfig.defaultSourcesConfigObject,
  metadata: _metadataConfig.defaultMetadataConfigObject,
  plugins: _pluginsConfig.defaultPluginsConfigObject
};
...
var PlayerOptions = function () {
  _createClass(PlayerOptions, [{
    ...
    set: function set(config) {
      this._playback = new _playbackConfig2.default(config);
    }
  }, {
    key: 'sources',
    get: function get() {
    ...
    set: function set(config) {
      this._sources = new _sourcesConfig2.default(config);
    }
  }, {
    key: 'metadata',
    get: function get() {
    ...
    set: function set(config) {
      this._metadata = new _metadataConfig2.default(config);
    }
  }, {
    key: 'plugins',
    get: function get() {
  ...
  function PlayerOptions() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPlayerOptions;

    _classCallCheck(this, PlayerOptions);

    this._playback = new _playbackConfig2.default(config.playback);
    this._sources = new _sourcesConfig2.default(config.sources);
    this._metadata = new _metadataConfig2.default(config.metadata);
    this._plugins = new _pluginsConfig2.default(config.plugins);
...
var DrmData = function () {
  _createClass(DrmData, [{
    key: 'licenseUrl',
    get: function get() {
  ...
  function DrmData(scheme, licenseUrl, certificate) {
    _classCallCheck(this, DrmData);
    ...
    } else if ((typeof scheme === 'undefined' ? 'undefined' : _typeof(scheme)) === 'object') {
...
function validate() {
  ...
  if (typeof params[0] === 'string' && typeof params[1] === 'string') return;
  if (_typeof(params[0]) === 'object' && typeof params[0].scheme === 'string' && typeof params[0].licenseUrl === 'string') return;
...
exports.getCapabilities = exports.BaseDrmProtocol = exports.Env = exports.PLAYER_NAME = exports.VERSION = exports.FakeEvent = exports.Error = exports.Utils = exports.TextStyle = exports.TextTrack = exports.AudioTrack = exports.VideoTrack = exports.Track = exports.BaseMiddleware = exports.BasePlugin = exports.registerPlugin = exports.BaseMediaSourceAdapter = exports.registerMediaSourceAdapter = exports.DrmData = exports.StreamPriority = exports.MediaSource = exports.defaultPlayerOptions = exports.PlayerOptions = undefined;
...
var _streamPriority = __webpack_require__(16);

var _streamPriority2 = _interopRequireDefault(_streamPriority);

var _mediaSource = __webpack_require__(17);
...
function loadPlayer(options) {
  options = options || new _playerOptions2.default();
  return new _player2.default(options.toJSON());
}

exports.PlayerOptions = _playerOptions2.default;
exports.defaultPlayerOptions = _playerOptions.defaultPlayerOptions;
exports.MediaSource = _mediaSource2.default;
exports.StreamPriority = _streamPriority2.default;
exports.DrmData = _drmData2.default;
...
var _html5Autoplay = __webpack_require__(43);

var _html5Autoplay2 = _interopRequireDefault(_html5Autoplay);

var _html5IsSupported = __webpack_require__(45);
...
var Html5 = function (_FakeEventTarget) {
  ...
  _createClass(Html5, [{
    ...
    value: function attach() {
      ...
      Object.keys(_events.HTML5_EVENTS).forEach(function (html5Event) {
        _this2._eventManager.listen(_this2._el, _events.HTML5_EVENTS[html5Event], function () {
          if (_events.HTML5_EVENTS[html5Event] === _events.HTML5_EVENTS.ERROR) {
      ...
      if (this._mediaSourceAdapter) {
        ...
        this._eventManager.listen(this._mediaSourceAdapter, _events.HTML5_EVENTS.ERROR, function (event) {
          return _this2.dispatchEvent(event);
        });
      }
    }
    ...
    value: function _handleVideoError() {
      ...
      this.dispatchEvent(new _fakeEvent2.default(_events.HTML5_EVENTS.ERROR, error));
    }
...
var _resolution = __webpack_require__(40);

var _util = __webpack_require__(2);

var Utils = _interopRequireWildcard(_util);

var _fairplay = __webpack_require__(41);
...
var NativeAdapter = function (_BaseMediaSourceAdapt) {
  ...
  _createClass(NativeAdapter, [{
    ...
    value: function _dispatchErrorCallback(error) {
      this._trigger(_events.HTML5_EVENTS.ERROR, error);
    }
    ...
    value: function load(startTime) {
      ...
      if (!this._loadPromise) {
        this._loadPromise = new Promise(function (resolve, reject) {
          _this3._eventManager.listenOnce(_this3._videoElement, _events.HTML5_EVENTS.LOADED_DATA, _this3._onLoadedData.bind(_this3, resolve));
          _this3._eventManager.listenOnce(_this3._videoElement, _events.HTML5_EVENTS.ERROR, _this3._onError.bind(_this3, reject));
          ...
          if (_this3._sourceObj && _this3._sourceObj.url) {
            ...
            _this3._trigger(_baseMediaSourceAdapter2.default.CustomEvents.ABR_MODE_CHANGED, { mode: _this3._isProgressivePlayback() ? 'manual' : 'auto' });
          }
          if (startTime) {
    ...
    value: function _onLoadedData(resolve) {
      ...
      if (this._videoElement.textTracks.length > 0) {
        ...
        this._eventManager.listenOnce(this._videoElement, _events.HTML5_EVENTS.CAN_PLAY, parseTracksAndResolve.bind(this));
      }
    }
      ...
      if (videoTrack instanceof _videoTrack2.default && videoTracks && videoTracks[videoTrack.index]) {
        ...
        this._eventManager.listenOnce(this._videoElement, _events.HTML5_EVENTS.LOADED_DATA, function () {
          if (_env2.default.browser.name === 'Android Browser') {
            ...
            _this6._eventManager.listenOnce(_this6._videoElement, _events.HTML5_EVENTS.DURATION_CHANGE, function () {
              _this6._videoElement.currentTime = currentTime;
            });
            _this6._eventManager.listenOnce(_this6._videoElement, _events.HTML5_EVENTS.SEEKED, function () {
...
var _encodingSources = __webpack_require__(44);
...
exports.defaultPlaybackConfigObject = exports.Preload = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _streamPriorityList = __webpack_require__(52);

var _streamPriorityList2 = _interopRequireDefault(_streamPriorityList);

var _streamPriority = __webpack_require__(16);

var _streamPriority2 = _interopRequireDefault(_streamPriority);

var _preferNativeConfig = __webpack_require__(53);

var _preferNativeConfig2 = _interopRequireDefault(_preferNativeConfig);
...
var defaultPlaybackConfigObject = exports.defaultPlaybackConfigObject = {
  audioLanguage: '',
  textLanguage: '',
  ...
  muted: false,
  streamPriority: [{
    engine: _streamPriority.EngineName.HTML5,
    format: _streamPriority.FormatName.HLS
  }, {
    engine: _streamPriority.EngineName.HTML5,
    format: _streamPriority.FormatName.DASH
  }, {
    engine: _streamPriority.EngineName.HTML5,
    format: _streamPriority.FormatName.PROGRESSIVE
  }],
  preferNative: {
    hls: false,
    dash: false
...
var PlaybackConfig = function () {
  _createClass(PlaybackConfig, [{
    ...
    set: function set(value) {
      if (value instanceof _streamPriorityList2.default) {
  ...
  function PlaybackConfig() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPlaybackConfigObject;

    _classCallCheck(this, PlaybackConfig);
    ...
    this._streamPriority = new _streamPriorityList2.default(config.streamPriority || defaultPlaybackConfigObject.streamPriority);
    this._preferNative = new _preferNativeConfig2.default(config.preferNative || defaultPlaybackConfigObject.preferNative);
  }
...
exports.default = PlaybackConfig;
...
var StreamPriorityList = function () {
  _createClass(StreamPriorityList, [{
    key: 'list',
    get: function get() {
      return this._list;
    },
    set: function set(value) {
      ...
      value.forEach(function (i) {
        return _this._list.push(new _streamPriority2.default(i.engine, i.format));
      });
    }
  }]);

  function StreamPriorityList() {
    var list = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

    _classCallCheck(this, StreamPriorityList);
  ...
  _createClass(StreamPriorityList, [{
    ...
    value: function toJSON() {
      ...
      this._list.forEach(function (item) {
        return response.push(item.toJSON());
      });
      return response;
    }
  }]);

  return StreamPriorityList;
}();
...
exports.default = StreamPriorityList;
...
var defaultPreferNativeObject = exports.defaultPreferNativeObject = {
  hls: false,
  dash: false
};

var PreferNativeConfig = function () {
  _createClass(PreferNativeConfig, [{
    key: 'hls',
    get: function get() {
      return this._hls;
    },
  ...
  function PreferNativeConfig() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPreferNativeObject;

    _classCallCheck(this, PreferNativeConfig);
  ...
  return PreferNativeConfig;
}();

exports.default = PreferNativeConfig;
...
exports.defaultSourcesConfigObject = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _mediaSourceList = __webpack_require__(55);

var _mediaSourceList2 = _interopRequireDefault(_mediaSourceList);
...
var defaultSourcesConfigObject = exports.defaultSourcesConfigObject = {
  hls: [],
  dash: [],
  progressive: []
};

var SourcesConfig = function () {
  _createClass(SourcesConfig, [{
    ...
    set: function set(value) {
      if (value instanceof _mediaSourceList2.default) {
        this._hls = value;
      } else if (Array.isArray(value)) {
  ...
  function SourcesConfig() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultSourcesConfigObject;

    _classCallCheck(this, SourcesConfig);

    this._hls = new _mediaSourceList2.default(config.hls || defaultSourcesConfigObject.hls);
    this._dash = new _mediaSourceList2.default(config.dash || defaultSourcesConfigObject.dash);
    this._progressive = new _mediaSourceList2.default(config.progressive || defaultSourcesConfigObject.progressive);
  }
...
var MediaSourceList = function () {
  _createClass(MediaSourceList, [{
    key: 'list',
    get: function get() {
      return this._list;
    },
    set: function set(value) {
      ...
      value.forEach(function (m) {
        var ms = new _mediaSource2.default(m.mimetype, m.url, m.id);
  ...
  function MediaSourceList() {
    ...
    _classCallCheck(this, MediaSourceList);
...
exports.default = MediaSourceList;
function validate(list) {
  if (!list) return;
  if (Array.isArray(list)) return;
  throw new TypeError('Stream priority list should be an array');
...
var defaultMetadataConfigObject = exports.defaultMetadataConfigObject = {
  poster: '',
  description: ''
};

var MetadataConfig = function () {
  _createClass(MetadataConfig, [{
    key: 'poster',
    get: function get() {
      return this._poster;
    },
  ...
  function MetadataConfig() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultMetadataConfigObject;

    _classCallCheck(this, MetadataConfig);
...
exports.default = MetadataConfig;
...
var defaultPluginsConfigObject = exports.defaultPluginsConfigObject = {};

var PluginsConfig = function () {
  _createClass(PluginsConfig, [{
    key: "map",
    get: function get() {
      return this._map;
    },
    set: function set(value) {
      ...
      if (value instanceof Map) {
        ...
        Object.keys(value).forEach(function (key) {
          return _this._map.set(key, value[key]);
        });
      }
    }
  }]);
  ...
  function PluginsConfig() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultPluginsConfigObject;

    _classCallCheck(this, PluginsConfig);
