...
var PlayerError = function () {
  ...
  _createClass(PlayerError, [{
    ...
    value: function dispatch(error) {
      ...
      var severityName = this.severity === 1 ? 'RECOVERABLE' : 'CRITICAL';
      ...
      var message = severityName + "." + categoryName + "." + codeName + "." + ' (' + this.data + ')';
  ...
  _createClass(Player, [{
    ...
    value: function _attachMedia() {
      ...
      if (this._engine) {
        ...
        this._eventManager.listen(this._engin, _events.CUSTOM_EVENTS.ERROR, function (event) {
          return _this6.dispatchEvent(event);
        });
...
var _playerError = __webpack_require__(4);
  ...
  _createClass(VTTCue, [{
    ...
    set: function set(value) {
      if (value < 0 || value > 100) {
        var ErrObj = {
          severity: _playerError2.default.Severity.RECOVERABLE,
          category: _playerError2.default.Category.TEXT,
          code: _playerError2.default.Code.BAD_VALUE,
          args: { message: "Position must be between 0 and 100." }
        };
        new _playerError2.default(ErrObj);
      }
...
var FairPlay = function (_BaseDrmProtocol) {
  ...
  _createClass(FairPlay, null, [{
    ...
    value: function _licenseRequestFailed(error) {
      var ErrObj = {
        severity: _playerError2.default.Severity.CRITICAL,
        category: _playerError2.default.Category.DRM,
        code: _playerError2.default.Code.BAD_FAIRPLAY_RESPONSE,
  ...
  _createClass(Html5, [{
    ...
    value: function attach() {
      ...
      if (this._mediaSourceAdapter) {
        ...
        this._eventManager.listen(this._mediaSourceAdapter, _events.CUSTOM_EVENTS.ERROR, function (event) {
          return _this2.dispatchEvent(event);
        });
      }
    }
...
var NativeAdapter = function (_BaseMediaSourceAdapt) {
  ...
  function NativeAdapter(videoElement, source, config) {
    ...
    _this._playerError = new _playerError2.default();
    _this._eventManager = new _eventManager2.default();
