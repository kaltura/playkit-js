...
var Player = function (_FakeEventTarget) {
  ...
  function Player() {
    ...
    _this._config = _playerOptions.defaultPlayerOptions;
  ...
  _createClass(Player, [{
    ...
    key: 'defaultConfig',
    get: function get() {
      return _playerOptions.defaultPlayerOptions;
    }
  }, {
    key: 'Event',
    get: function get() {
...
function loadPlayer(options) {
  if (options) {
    if (options instanceof _playerOptions2.default) {
      return new _player2.default(options.toJSON());
    } else {
      return new _player2.default(new _playerOptions2.default(options).toJSON());
    }
  } else {
