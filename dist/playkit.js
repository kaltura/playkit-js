...
var Player = function (_FakeEventTarget) {
  ...
  _createClass(Player, [{
    ...
    value: function isFullscreen() {
      var isNativeOnly = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

      var result = isNativeOnly ? this._fullscreenController.isNativeFullscreen() : this._fullscreenController.isFullscreen();
      var native = this._fullscreenController.isNativeFullscreen();
    ...
    key: 'enterFullscreen',
    value: function enterFullscreen(fullScreenElement) {
      if (!this.isFullscreen()) {
...
var BaseMediaSourceAdapter = function (_FakeEventTarget) {
  ...
  function BaseMediaSourceAdapter(videoElement, source) {
    ...
    _this._capabilities = { fpsControl: false };
  ...
  _createClass(NativeAdapter, [{
    ...
    value: function _maybeSetDrmPlayback() {
      ...
      if (NativeAdapter._drmProtocol && this._sourceObj && this._sourceObj.drmData) {
        var drmConfig = { licenseUrl: '', certificate: '' };
 ...
 * @const
 */
var IN_BROWSER_FULLSCREEN_FOR_IOS = 'in-browser-fullscreen-mode';
...
var FullscreenController = function () {
  ...
  _createClass(FullscreenController, [{
    ...
    value: function isNativeFullscreen() {
      var videoElement = this._player.getVideoElement();
      return typeof document.fullscreenElement !== 'undefined' && Boolean(document.fullscreenElement) || typeof document.webkitFullscreenElement !== 'undefined' && Boolean(document.webkitFullscreenElement) || typeof document.mozFullScreenElement !== 'undefined' && Boolean(document.mozFullScreenElement) || typeof document.msFullscreenElement !== 'undefined' && Boolean(document.msFullscreenElement) || typeof videoElement.webkitDisplayingFullscreen !== 'undefined' && Boolean(videoElement.webkitDisplayingFullscreen);
    }
    ...
    value: function enterFullscreen(element) {
      var fullScreenElement = element ? element : this._player.getView();
