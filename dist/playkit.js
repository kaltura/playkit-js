...
var Player = function (_FakeEventTarget) {
  ...
  function Player() {
    ...
    if (config.logLevel && _this.LogLevel[config.logLevel]) {
      (0, _logger.setLogLevel)(_this.LogLevel[config.logLevel]);
    }
...
(0, _logger2.default)().log('%c ' + "playkit-js" + ' ' + "0.16.0", "color: #98ff98;  font-size: large");
(0, _logger2.default)().log('%c For more details see ' + "https://github.com/kaltura/playkit-js", "color: #98ff98;");
