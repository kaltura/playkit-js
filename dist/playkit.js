...
var PlayerOptions = function () {
  ...
  function PlayerOptions(config) {
    ...
    this._playback = new _playbackConfig2.default(config && config.playback);
    this._sources = new _sourcesConfig2.default(config && config.sources);
    this._metadata = new _metadataConfig2.default(config && config.metadata);
    this._plugins = new _pluginsConfig2.default(config && config.plugins);
...
var PlaybackConfig = function () {
  ...
  function PlaybackConfig(config) {
    ...
    this._streamPriority = new _streamPriorityList2.default();
    this._preferNative = new _preferNativeConfig2.default();
    ...
    if (config && config.streamPriority) {
      ...
      this._streamPriority.list.push(new _streamPriority2.default(_streamPriority.EngineName.HTML5, _streamPriority.FormatName.HLS));
      this._streamPriority.list.push(new _streamPriority2.default(_streamPriority.EngineName.HTML5, _streamPriority.FormatName.DASH));
      this._streamPriority.list.push(new _streamPriority2.default(_streamPriority.EngineName.HTML5, _streamPriority.FormatName.PROGRESSIVE));
    }
  }
...
var SourcesConfig = function () {
  ...
  function SourcesConfig(config) {
    _classCallCheck(this, SourcesConfig);

    this._hls = new _mediaSourceList2.default();
    this._dash = new _mediaSourceList2.default();
    this._progressive = new _mediaSourceList2.default();
