...
var _multiMap = __webpack_require__(16);
...
var _fakeEventTarget = __webpack_require__(15);
...
var _playerConfig = __webpack_require__(43);
...
var _drmScheme = __webpack_require__(11);
...
var OS_VERSION = _env2.default.os.version;
...
var _nativeAdapter = __webpack_require__(26);
...
var _drmSupport = __webpack_require__(17);
...
var _baseDrmProtocol = __webpack_require__(23);
...
FairPlay._logger = _logger2.default.getLogger('FairPlay');
...
var Html5 = function (_FakeEventTarget) {
  ...
  _createClass(Html5, null, [{
    ...
    /**
     * Checks if the engine can play a given drm data.
     * @param {Array<Object>} drmData - The drm data to check.
     * @returns {boolean} - Whether the engine can play the drm data.
     * @public
     * @static
     */
    ...
    key: 'canPlayDrm',
    value: function canPlayDrm(drmData) {
      return drmData && drmData.length > 0 ? _mediaSourceProvider2.default.canPlayDrm(drmData) : true;
    }
...
var _resolution = __webpack_require__(34);

var _util = __webpack_require__(2);

var Utils = _interopRequireWildcard(_util);

var _fairplay = __webpack_require__(24);
...
exports.DrmSupport = _drmSupport2.default;
