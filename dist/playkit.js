...
var _severity = __webpack_require__(33);
...
var _eventType = __webpack_require__(55);
...
var _stateManager = __webpack_require__(42);
...
var _stateType = __webpack_require__(53);

var _trackType = __webpack_require__(54);

var _streamType = __webpack_require__(56);

var _engineType = __webpack_require__(57);

var _mediaType = __webpack_require__(58);

var _abrModeType = __webpack_require__(59);

var _playbackMiddleware = __webpack_require__(45);

var _playbackMiddleware2 = _interopRequireDefault(_playbackMiddleware);

var _playerConfig = __webpack_require__(47);
...
var Player = function (_FakeEventTarget) {
  ...
  _createClass(Player, [{
    ...
    value: function isLive() {
      return !!(this._config.type === _mediaType.MediaType.LIVE || this._engine && this._engine.isLive());
    }
    ...
    value: function _hasSources(sources) {
      if (sources) {
        return !!Object.keys(sources).find(function (format) {
    ...
    value: function _createReadyPromise() {
      ...
      this._readyPromise = new Promise(function (resolve, reject) {
        _this4._eventManager.listen(_this4, _eventType.CustomEventType.TRACKS_CHANGED, resolve);
        _this4._eventManager.listen(_this4, _eventType.Html5EventType.ERROR, reject);
      }).catch(function () {
          ...
          if (Engine) {
            ...
            if (formatSources && formatSources.length > 0) {
              ...
              if (Engine.canPlaySource(source, preferNative[format])) {
                ...
                _this5.dispatchEvent(new _fakeEvent2.default(_eventType.CustomEventType.SOURCE_SELECTED, { selectedSource: formatSources }));
                return {
                  v: true
                };
              }
    ...
    value: function _attachMedia() {
      ...
      if (this._engine) {
        Object.keys(_eventType.Html5EventType).forEach(function (html5Event) {
          _this6._eventManager.listen(_this6._engine, _eventType.Html5EventType[html5Event], function (event) {
          ...
          Player.getCapabilities(this.engineType).then(function (capabilities) {
            if (capabilities.autoplay) {
              ...
              if (allowMutedAutoPlay) {
                ...
                _this9.muted = true;
                _this9.play();
                _this9.dispatchEvent(new _fakeEvent2.default(_eventType.CustomEventType.FALLBACK_TO_MUTED_AUTOPLAY));
              } else {
                ...
                _this9.dispatchEvent(new _fakeEvent2.default(_eventType.CustomEventType.AUTOPLAY_FAILED));
              }
            }
          });
        }
    ...
    value: function _play() {
      ...
      if (this._engine.src) {
        ...
        this.ready().then(function () {
          ...
          _this10.dispatchEvent(new _fakeEvent2.default(_eventType.Html5EventType.ERROR, error));
        });
      }
    }
    ...
    value: function _addTextTrackOffOption() {
      var textTracks = this.getTracks(_trackType.TrackType.TEXT);
...
BaseMediaSourceAdapter.CustomEvents = _eventType.CustomEventType;
BaseMediaSourceAdapter.Html5Events = _eventType.Html5EventType;
...
var _drmSupport = __webpack_require__(38);
...
var _html5Autoplay = __webpack_require__(39);

var _html5Autoplay2 = _interopRequireDefault(_html5Autoplay);

var _html5IsSupported = __webpack_require__(41);
  ...
  _createClass(Html5, [{
    ...
    value: function attach() {
      ...
      if (this._mediaSourceAdapter) {
        ...
        this._eventManager.listen(this._mediaSourceAdapter, _eventType.Html5EventType.DURATION_CHANGE, function (event) {
          return _this2.dispatchEvent(event);
        });
      }
    }
...
var _resolution = __webpack_require__(36);

var _util = __webpack_require__(2);

var Utils = _interopRequireWildcard(_util);

var _fairplay = __webpack_require__(37);
  ...
  _createClass(NativeAdapter, [{
    ...
    value: function _handleLiveDurationChange() {
      ...
      this._liveDurationChangeInterval = setInterval(function () {
        var liveEdge = _this11._getLiveEdge();
        if (_this11._liveEdge !== liveEdge) {
          _this11._liveEdge = liveEdge;
          _this11._trigger(_eventType.Html5EventType.DURATION_CHANGE, {});
        }
      }, 2000);
    }
...
var _encodingSources = __webpack_require__(40);
